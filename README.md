...
1. Node.js( 14._ ) [ 12._ , 16.\* では動作しません]
2. Yarn
...
Fork したリポジトリは、Fork 元のリポジトリの状態を自動的に反映してくれませんので、自分で更新をする必要があります。
...
### GitHub アカウントでサインアップしたので、パスワードがないという方へ
...
### 2021/06/01 20:00 以前に挑戦して、Station15 で詰まっている方へ
